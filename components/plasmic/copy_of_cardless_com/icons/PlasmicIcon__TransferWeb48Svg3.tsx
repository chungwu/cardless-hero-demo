...
export type TransferWeb48Svg3IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TransferWeb48Svg3Icon(props: TransferWeb48Svg3IconProps) {
...
export default TransferWeb48Svg3Icon;
/* prettier-ignore-end */
