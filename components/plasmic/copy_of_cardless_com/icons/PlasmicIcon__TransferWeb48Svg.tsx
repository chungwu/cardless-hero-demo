...
export type TransferWeb48SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TransferWeb48SvgIcon(props: TransferWeb48SvgIconProps) {
...
export default TransferWeb48SvgIcon;
/* prettier-ignore-end */
