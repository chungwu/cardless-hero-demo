...
export type CashWeb48Svg3IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CashWeb48Svg3Icon(props: CashWeb48Svg3IconProps) {
...
export default CashWeb48Svg3Icon;
/* prettier-ignore-end */
