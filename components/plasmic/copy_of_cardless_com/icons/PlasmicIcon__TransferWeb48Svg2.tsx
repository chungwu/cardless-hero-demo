...
export type TransferWeb48Svg2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TransferWeb48Svg2Icon(props: TransferWeb48Svg2IconProps) {
...
export default TransferWeb48Svg2Icon;
/* prettier-ignore-end */
