...
export type DonateWeb48SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function DonateWeb48SvgIcon(props: DonateWeb48SvgIconProps) {
  ...
  return (
    ...
    >
      ...
      <rect width={"48"} height={"48"} rx={"8"} fill={"#FCEAE9"}></rect>

      <g clipPath={"url(#R5GYMER2pa)"}>
        <path
          d={
...
export default DonateWeb48SvgIcon;
/* prettier-ignore-end */
