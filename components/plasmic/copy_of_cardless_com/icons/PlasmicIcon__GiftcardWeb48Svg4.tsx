...
export type GiftcardWeb48Svg4IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function GiftcardWeb48Svg4Icon(props: GiftcardWeb48Svg4IconProps) {
...
export default GiftcardWeb48Svg4Icon;
/* prettier-ignore-end */
