...
export type GiftcardWeb48Svg2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function GiftcardWeb48Svg2Icon(props: GiftcardWeb48Svg2IconProps) {
...
export default GiftcardWeb48Svg2Icon;
/* prettier-ignore-end */
