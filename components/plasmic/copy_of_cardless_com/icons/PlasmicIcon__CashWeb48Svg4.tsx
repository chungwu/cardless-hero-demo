...
export type CashWeb48Svg4IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CashWeb48Svg4Icon(props: CashWeb48Svg4IconProps) {
...
export default CashWeb48Svg4Icon;
/* prettier-ignore-end */
