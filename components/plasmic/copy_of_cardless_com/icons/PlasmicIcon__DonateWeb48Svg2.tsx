...
export type DonateWeb48Svg2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function DonateWeb48Svg2Icon(props: DonateWeb48Svg2IconProps) {
...
export default DonateWeb48Svg2Icon;
/* prettier-ignore-end */
