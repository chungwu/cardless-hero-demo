...
export type GiftcardWeb48SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function GiftcardWeb48SvgIcon(props: GiftcardWeb48SvgIconProps) {
...
export default GiftcardWeb48SvgIcon;
/* prettier-ignore-end */
