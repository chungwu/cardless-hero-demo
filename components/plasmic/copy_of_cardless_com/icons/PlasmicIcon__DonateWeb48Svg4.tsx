...
export type DonateWeb48Svg4IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function DonateWeb48Svg4Icon(props: DonateWeb48Svg4IconProps) {
...
export default DonateWeb48Svg4Icon;
/* prettier-ignore-end */
